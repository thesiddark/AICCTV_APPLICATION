...
class ViewOwnPost extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const PublicViewSuspiciousActivity(),
    );
  }
}

class PublicViewSuspiciousActivity extends StatefulWidget {
  const PublicViewSuspiciousActivity({Key? key}) : super(key: key);

  @override
  State<PublicViewSuspiciousActivity> createState() =>
      _PublicViewSuspiciousActivityState();
}

class _PublicViewSuspiciousActivityState
    extends State<PublicViewSuspiciousActivity> {
  _PublicViewSuspiciousActivityState() {
    ViewOwnPost();
  }
