              ...
              child:  AnimatedOpacity(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextWidget("Snap Notify", 35, Colors.black, FontWeight.bold,letterSpace: 5,),
                    const SizedBox(height: 5,),
                    TextWidget("By", 35, Colors.black, FontWeight.bold,letterSpace: 5,),
                    const SizedBox(height: 20,),
                    TextWidget("Devagiri College", 18, Colors.black.withOpacity(.7), FontWeight.bold),
                  ],
                ),
              ),
               ),
                ...
                child: InkWell(
                  onTap: ()
                  {
                    ...
                    Timer(const Duration(milliseconds: 400),() {
                      ...
                      // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  NotiPage(title: ""),));
                    },);
                  },
                  child: AnimatedOpacity(
                    opacity: opacity,
